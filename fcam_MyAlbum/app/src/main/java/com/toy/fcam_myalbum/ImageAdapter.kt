...
import com.toy.fcam_myalbum.databinding.ItemImageBinding
import com.toy.fcam_myalbum.databinding.ItemLoadMoreBinding

class ImageAdapter(private val itemClickListener: ItemClickListener) : ListAdapter<ImageItems, RecyclerView.ViewHolder>(diffUtil) {
